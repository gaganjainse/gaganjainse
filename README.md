...
| <a href="https://github.com/gaganjainse/portfolio"><b>Portfolio</b></a> <a href="https://gaganjain.vercel.app">(live)</a> | Personal site built with React 19, TypeScript, Vite 8, Tailwind CSS 4, Framer Motion. | React, TypeScript, Tailwind |
...
**Backend:** Flask · Laravel · Node.js · Express · Axum (Rust) · Supabase · REST APIs · WebSockets

**Databases:** MySQL · MongoDB · Redis · SQLite

**DevOps:** Docker · GitHub Actions · Nginx · Gunicorn · Prometheus · Linux

**AI/ML:** Ollama · YOLO · OpenCV · NLP · Computer Vision · PuLP (Linear Programming) · Folium
